...
with open('in.txt', 'r') as infile:
	...
	with open('out.txt', 'w') as outfile:
		...
		outfile.write("Mensal: "+", ".join([format(value, ',.2f') for value in calculo_maximo["mensal"][1:-1]])+"\n")
		outfile.write("Multa: "+format(calculo_maximo["multa_anual"], ',.2f')+"\n")
		outfile.write("Multa Mensal: "+", ".join([format(value, ',.2f') for value in calculo_maximo["multa"][1:-1]])+"\n")
		outfile.write("\n")
		outfile.write("Min: "+format(minimo, ',.2f')+"\n")
		outfile.write("Anual: "+format(calculo_minimo["anual"], ',.2f')+"\n")
		outfile.write("Mensal: "+", ".join([format(value, ',.2f') for value in calculo_minimo["mensal"][1:-1]])+"\n")
		outfile.write("Multa: "+format(calculo_minimo["multa_anual"], ',.2f')+"\n")
		outfile.write("Multa Mensal: "+", ".join([format(value, ',.2f') for value in calculo_minimo["multa"][1:-1]])+"\n")
		outfile.write("\n")
		outfile.write("Media: "+format(media, ',.2f')+"\n")
		outfile.write("Anual: "+format(calculo_media["anual"], ',.2f')+"\n")
		outfile.write("Mensal: "+", ".join([format(value, ',.2f') for value in calculo_media["mensal"][1:-1]])+"\n")
		outfile.write("Multa: "+format(calculo_media["multa_anual"], ',.2f')+"\n")
		outfile.write("Multa Mensal: "+", ".join([format(value, ',.2f') for value in calculo_media["multa"][1:-1]])+"\n")
		outfile.write("\n")
		outfile.write("Otima: "+format(cand_opt, ',.2f')+"\n")
		outfile.write("Anual: "+format(opt["anual"], ',.2f')+"\n")
		outfile.write("Mensal: "+", ".join([format(value, ',.2f') for value in opt["mensal"][1:-1]])+"\n")
		outfile.write("Multa: "+format(opt["multa_anual"], ',.2f')+"\n")
		outfile.write("Multa Mensal: "+", ".join([format(value, ',.2f') for value in opt["multa"][1:-1]])+"\n")
		outfile.write("\n")